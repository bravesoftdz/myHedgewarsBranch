/****************************************************************************
** Meta object code from reading C++ file 'pageselectweapon.h'
**
...
#error "The header file 'pageselectweapon.h' doesn't include <QObject>."
...
void PageSelectWeapon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData PageSelectWeapon::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PageSelectWeapon::staticMetaObject = {
    { &AbstractPage::staticMetaObject, qt_meta_stringdata_PageSelectWeapon,
      qt_meta_data_PageSelectWeapon, &staticMetaObjectExtraData }
};
