/****************************************************************************
** Meta object code from reading C++ file 'pagemultiplayer.h'
**
...
#error "The header file 'pagemultiplayer.h' doesn't include <QObject>."
...
void PageMultiplayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        PageMultiplayer *_t = static_cast<PageMultiplayer *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData PageMultiplayer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PageMultiplayer::staticMetaObject = {
    { &AbstractPage::staticMetaObject, qt_meta_stringdata_PageMultiplayer,
      qt_meta_data_PageMultiplayer, &staticMetaObjectExtraData }
};
