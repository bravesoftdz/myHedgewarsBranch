/****************************************************************************
** Meta object code from reading C++ file 'pageingame.h'
**
...
#error "The header file 'pageingame.h' doesn't include <QObject>."
...
void PageInGame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData PageInGame::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PageInGame::staticMetaObject = {
    { &AbstractPage::staticMetaObject, qt_meta_stringdata_PageInGame,
      qt_meta_data_PageInGame, &staticMetaObjectExtraData }
};
