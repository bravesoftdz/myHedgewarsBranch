...
static const char qt_meta_stringdata_HWMap[] = {
    "HWMap\0\0newImage\0ImageReceived(QPixmap)\0"
    "hhLimit\0HHLimitReceived(int)\0"
};

void HWMap::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        HWMap *_t = static_cast<HWMap *>(_o);
        switch (_id) {
        case 0: _t->ImageReceived((*reinterpret_cast< const QPixmap(*)>(_a[1]))); break;
        case 1: _t->HHLimitReceived((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData HWMap::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject HWMap::staticMetaObject = {
    { &TCPBase::staticMetaObject, qt_meta_stringdata_HWMap,
      qt_meta_data_HWMap, &staticMetaObjectExtraData }
};
...
// SIGNAL 0
void HWMap::ImageReceived(const QPixmap & _t1)
{
