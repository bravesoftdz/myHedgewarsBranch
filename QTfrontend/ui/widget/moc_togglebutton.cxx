...
void ToggleButtonWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        ToggleButtonWidget *_t = static_cast<ToggleButtonWidget *>(_o);
        switch (_id) {
        case 0: _t->eventToggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData ToggleButtonWidget::staticMetaObjectExtraData = {
...
const QMetaObject ToggleButtonWidget::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_ToggleButtonWidget,
      qt_meta_data_ToggleButtonWidget, &staticMetaObjectExtraData }
};
