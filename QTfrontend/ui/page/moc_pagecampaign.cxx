/****************************************************************************
** Meta object code from reading C++ file 'pagecampaign.h'
**
...
#error "The header file 'pagecampaign.h' doesn't include <QObject>."
...
void PageCampaign::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData PageCampaign::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PageCampaign::staticMetaObject = {
    { &AbstractPage::staticMetaObject, qt_meta_stringdata_PageCampaign,
      qt_meta_data_PageCampaign, &staticMetaObjectExtraData }
};
