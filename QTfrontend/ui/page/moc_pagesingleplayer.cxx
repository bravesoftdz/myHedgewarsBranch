/****************************************************************************
** Meta object code from reading C++ file 'pagesingleplayer.h'
**
...
#error "The header file 'pagesingleplayer.h' doesn't include <QObject>."
...
void PageSinglePlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData PageSinglePlayer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PageSinglePlayer::staticMetaObject = {
    { &AbstractPage::staticMetaObject, qt_meta_stringdata_PageSinglePlayer,
      qt_meta_data_PageSinglePlayer, &staticMetaObjectExtraData }
};
